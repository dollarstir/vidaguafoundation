...
<head>
	...
	<title> Events & Campaigns| Vidagua</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcroumb-title text-center">
						...
						<h6><a href="index.html">Home</a> / About Us/ Events & Campaigns</h6>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
                    ...
                    <img src="assets/fp/evt.jpg" alt="">
				</div>
				<div class="col-lg-5">
					<div class="about-content">
						<div class="section-title">
							<!-- <h6>A little Bit More</h6> -->
							<h2>  <b>Events & Campaigns</b></h2>
						</div>

						<p>
                        <strong>No current event.</strong>
                        </p>
