...
<head>
	...
	<title>  In the News| Vidagua</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcroumb-title text-center">
						<h1> In the News</h1>
						<h6><a href="index.html">Home</a> / About Us/  In the News</h6>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
                    ...
                    <img src="assets/fp/evt4.jpg" alt="">
				</div>
				<div class="col-lg-5">
					<div class="about-content">
						...
						<p>
                        <strong>No current news. Please visit this page again soon. Thank you.</strong>
                        </p>
